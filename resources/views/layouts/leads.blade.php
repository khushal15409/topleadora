...
<body class="leads-layout @yield('body_class')">
    ...
    <div id="leads-toast-host" class="leads-toast-host position-fixed top-0 start-50 translate-middle-x w-100 px-2" style="max-width: 480px;" aria-live="polite" aria-atomic="true"></div>
    <script>
