<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->routeIs('admin.marketing.*') ? 'active open' : '' }}">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->routeIs('admin.marketing.services.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.marketing.services.index') }}" class="menu-link">
                            <div>Services</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->routeIs('admin.marketing.countries.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.marketing.countries.index') }}" class="menu-link">
                            <div>Countries</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->routeIs('admin.marketing.landing-pages.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.marketing.landing-pages.index') }}" class="menu-link">
                            <div>Landing pages</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->routeIs('admin.marketing.form-fields.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.marketing.form-fields.index') }}" class="menu-link">
                            <div>Form fields</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->routeIs('admin.marketing.leads.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.marketing.leads.index') }}" class="menu-link">
                            <div>Marketing Leads</div>
                        </a>
                    </li>
                </ul>
            </li>
        ...
        @if(isApiClient() && !$isSuperAdminRole)
            ...
            <li class="menu-item {{ request()->routeIs('dashboard.api.overview') ? 'active' : '' }}">
                <a href="{{ route('dashboard.api.overview') }}" class="menu-link">
                    <i class="menu-icon icon-base ri ri-pulse-line"></i>
                    <div>API Usage Overview</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('dashboard.api.keys.*') ? 'active' : '' }}">
                <a href="{{ route('dashboard.api.keys.index') }}" class="menu-link">
                    <i class="menu-icon icon-base ri ri-key-2-line"></i>
                    <div>API Keys</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('dashboard.api.wallet') ? 'active' : '' }}">
                <a href="{{ route('dashboard.api.wallet') }}" class="menu-link">
                    <i class="menu-icon icon-base ri ri-wallet-3-line"></i>
                    <div>API Wallet</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('dashboard.api.logs') ? 'active' : '' }}">
                <a href="{{ route('dashboard.api.logs') }}" class="menu-link">
        ...
        @unless (auth()->user()?->hasAnyRole([\App\Support\Roles::SUPER_ADMIN, \App\Support\Roles::ORGANIZATION]) || isSuperAdmin())
            <li class="menu-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                <a href="{{ route('admin.dashboard') }}" class="menu-link">
                    <i class="menu-icon icon-base ri ri-home-smile-line"></i>
                    <div>Dashboard</div>
